...
public class LoginForm extends JPanel {
    ...
    private JButton goToRegisterButton = new JButton("Create an account");
    ...
    private void createForm() {
        ...
        goToRegisterButton.setOpaque(false);
        goToRegisterButton.setBorderPainted(false);
        goToRegisterButton.setForeground(Color.RED);
        this.add(goToRegisterButton, c);
    ...
    public void addGoToRegisterListener(ActionListener a) {
        goToRegisterButton.addActionListener(a);
    }
